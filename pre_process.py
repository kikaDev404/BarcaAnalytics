...
barca_data.loc[(barca_data['HomeTeam'] == 'Barcelona') & (barca_data['HTR'] == 'H'), 'Half Time Result'] = 'Leading'
barca_data.loc[(barca_data['AwayTeam'] == 'Barcelona') & (barca_data['HTR'] == 'A'), 'Half Time Result'] = 'Leading'
barca_data.loc[barca_data['HTR'] == 'D', 'Half Time Result'] = 'Draw'
barca_data.loc[(barca_data['HomeTeam'] == 'Barcelona') & (barca_data['HTR'] == 'A'), 'Half Time Result'] = 'Trailing'
barca_data.loc[(barca_data['AwayTeam'] == 'Barcelona') & (barca_data['HTR'] == 'H'), 'Half Time Result'] = 'Trailing'
